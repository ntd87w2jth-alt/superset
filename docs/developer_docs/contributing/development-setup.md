...
:::note
We recommend and support `docker compose` as the main way to run Superset for development.
**Most people should stick to the first few sections - ("Fork & Clone", "docker compose" and "Installing Dev Tools")**
:::
...
- **Check platform-specific files** for comprehensive development guidelines, coding standards, and critical refactor information:
  - [`CLAUDE.md`](https://github.com/apache/superset/blob/master/CLAUDE.md) - For Claude/Anthropic tools
  - [`.github/copilot-instructions.md`](https://github.com/apache/superset/blob/master/.github/copilot-instructions.md) - For GitHub Copilot
  - [`GEMINI.md`](https://github.com/apache/superset/blob/master/GEMINI.md) - For Google Gemini tools
  - [`GPT.md`](https://github.com/apache/superset/blob/master/GPT.md) - For OpenAI/ChatGPT tools
  - [`.cursor/rules/dev-standard.mdc`](https://github.com/apache/superset/blob/master/.cursor/rules/dev-standard.mdc) - For Cursor editor
- Follow the TypeScript migration guidelines and avoid deprecated patterns listed in the platform-specific files above
...
For detailed development context, environment setup, and coding guidelines, see the platform-specific LLM files linked above.
...
**Note: the FLASK_APP env var should not need to be set, as it is controlled
